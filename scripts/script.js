...
// работа с хранилищем - для корзины
...
// типа защита - страница категорий
try {
        ...
        li.innerHTML = `
                        <article class="good">
                            <a class="good__link-img" href="card-good.html#${id}">
                                <img class="good__img" src="goods-image/${preview}" alt="preview ${name}">
                            </a>
    ...
    const renderCardGood = ([{ id, brand, name, cost, color, sizes, photo }]) => {
        ...
        cardGoodBuy.addEventListener("click", (event) => {
            ...
            if (cardGoodBuy.classList.contains("delete")) {
                const itemId = cartData.findIndex((item) => item.id === id);
